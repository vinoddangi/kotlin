...
public class PseudoValueTestGenerated extends AbstractPseudoValueTest {
    ...
    @InnerTestClasses({Cfg.Arrays.class, Cfg.Basic.class, Cfg.Bugs.class, Cfg.ControlStructures.class, Cfg.Conventions.class, Cfg.DeadCode.class, Cfg.Declarations.class, Cfg.Expressions.class, Cfg.Functions.class, Cfg.SecondaryConstructors.class, Cfg.TailCalls.class})
    @RunWith(JUnit3RunnerWithInners.class)
